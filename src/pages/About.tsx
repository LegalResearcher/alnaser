        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-8 md:p-10 mb-6 shadow-sm">
            ...
            <p className="text-slate-500 text-sm mt-4 leading-relaxed">
              تغطي المنصة جميع مواد الشريعة والقانون عبر المستويات الدراسية الأربعة، بنماذج اختبارات مطابقة للامتحانات الرسمية من 2020 إلى 2025.
            </p>
          </div>
