...
باختصار: أنت مجهول الهوية بالكامل من لحظة دخولك حتى مغادرتك.`,
  },
  {
    ...
    content: `الإحصائيات التي نراها هي أرقام إجمالية فقط — مثل: كم اختباراً أُجري في مادة معينة، وما نسبة النجاح العامة. هذه الأرقام تساعدنا على:
• تحسين جودة الأسئلة والمحتوى التعليمي.
• مراقبة أداء المنصة وضمان استقرارها التقني.
لا توجد "بياناتك" لدينا حتى نبيعها أو نشاركها — أنت مجرد رقم في إحصائية عامة لا أكثر.`,
  },
  {
    icon: Cookie,
...
المنصة أداة تعليمية مفتوحة — أنت تستخدمها وتغادر دون أن تترك أثراً يدل عليك.`,
  },
  {
    icon: Mail,
    title: 'تواصل معنا',
    content: `لأي استفسار أو اقتراح، يسعدنا التواصل معك عبر:
• البريد الإلكتروني: info@alnaseer.org
