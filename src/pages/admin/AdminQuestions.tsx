 ...
 * Version: 11.5 (Fix: Option D Not-Null Constraint)
 */
...
const AdminQuestions = () => {
  ...
  // ===============================================
  // === الحل لمشكلة (Not-Null Constraint) ===
  // ===============================================
  const bulkSave = useMutation({
    mutationFn: async (list: any[]) => {
      ...
      const formatted = list.map(q => ({
        ...
        option_a: q.option_a || "", // نرسل نص فارغ بدلاً من null
        option_b: q.option_b || "", // نرسل نص فارغ بدلاً من null
        option_c: q.option_c || "", // هذا هو الحل للخطأ في الصورة
        option_d: q.option_d || "", // هذا هو الحل للخطأ في الصورة (Violates not-null)
