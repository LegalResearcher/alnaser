...
export const ALL_EXAM_YEARS = [2020, 2021, 2022, 2023, 2024, 2025, 2026] as const;
export type ExamYear = typeof ALL_EXAM_YEARS[number];

// legacy alias – kept for any other imports that still reference EXAM_YEARS
export const EXAM_YEARS = ALL_EXAM_YEARS;
