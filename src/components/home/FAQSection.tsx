...
const faqs = [
  {
    question: 'ما هي منصة الناصر القانونية؟',
    answer: 'منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة — مصممة لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.',
  },
  {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-500 text-lg md:text-xl leading-relaxed">
            لقد جمعنا لك أكثر الأسئلة شيوعاً لمساعدتك في فهم كيفية تحقيق أقصى استفادة من منصة الناصر القانونية.
          </p>
        </div>
