...
const faqs = [
  {
    ...
    answer: 'منصة تعليمية إلكترونية متخصصة في تقديم اختبارات تفاعلية للباحثين القانونيين، تضم أكثر من 5000 سؤال في مختلف المجالات القانونية موزعة على 4 مستويات و43 مادة.',
  },
  {
