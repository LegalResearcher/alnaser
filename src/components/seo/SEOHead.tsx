...
export const HomeSEO = () => (
  <SEOHead
    ...
    description="المنصة الأولى لتدريب وتأهيل الباحثين القانونيين في اليمن — بنك أسئلة يضم أكثر من 10000 سؤال في 43 مادة قانونية موزعة على 4 مستويات دراسية."
    ...
    schema={{
      ...
      offers: {
        ...
        price: '0',
        priceCurrency: 'USD',
        description: 'اختبارات قانونية مجانية — أكثر من 10000 سؤال',
      },
    }}
  />
);
