...
// أنواع البيانات
// ─────────────────────────────────────────────────────────────
export type LegalCategory = 'law' | 'regulation' | 'prosecution_instruction' | 'contract_template';
...
export const CATEGORY_THEME: Record<LegalCategory, {
  ...
  contract_template: {
    headerBg: 'bg-[#5b3a29]',
    headerText: 'text-white',
    circleColor: 'bg-[#8a5a3b] text-white',
    articleNumColor: 'text-[#8a5a3b]',
    label: 'صيغ وعقود قانونية',
    path: 'templates',
    accentBorder: 'border-[#8a5a3b]/30',
    accentBg: 'bg-[#8a5a3b]/5 dark:bg-[#8a5a3b]/10',
  },
};
