...
export default async function handler(req: Request): Promise<Response> {
  ...
  let title  = SITE_NAME;
  let desc   = 'منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة — مصممة لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.';
  let body   = '';
  ...
  // ── /about ──
    ...
    desc  = 'منصة الناصر القانونية — مبادرة أ. معين الناصر لخدمة طلاب الشريعة والقانون والمحامين والباحثين في اليمن. منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة.';
