...
export default async function handler(req: Request): Promise<Response> {
  ...
  // ── القيم الافتراضية ──
  let title       = SITE_NAME;
  let description = 'منصة الناصر القانونية هي منصة رقمية مستقلة، تم تأسيسها وتطويرها برؤية وإشراف أ. معين الناصر. تضم المنصة أكثر من ٢٥٬٠٢٨+ سؤال مؤتمت ومكتبة قانونية متكاملة، جرى تصميمها خصيصاً لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.';
  let bodyContent = '';
  ...
  if (pathname === '/') {
    bodyContent = `
      <h2>منصة الناصر القانونية</h2>
      <p>منصة الناصر القانونية هي منصة رقمية مستقلة، تم تأسيسها وتطويرها برؤية وإشراف أ. معين الناصر. تضم المنصة أكثر من ٢٥٬٠٢٨+ سؤال مؤتمت ومكتبة قانونية متكاملة، جرى تصميمها خصيصاً لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.</p>
      ...
      <h3>المميزات</h3>
      <ul>
        <li>بنك أسئلة يضم أكثر من 25,000 سؤال مؤتمت</li>
  ...
  // ── /challenge/:id ──
    ...
    if (m) {
      ...
      if (d) {
        ...
        description = 'انضم إلى التحدي الآن على منصة الناصر القانونية';
  ...
  // ── /levels ──
    ...
    description = 'اختر مستواك الدراسي وابدأ رحلتك القانونية — 4 مستويات تغطي كافة فروع الشريعة والقانون لطلاب كلية الشريعة والقانون والمحامين والباحثين في اليمن.';
    bodyContent = `
