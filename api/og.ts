...
export default async function handler(req: Request): Promise<Response> {
  ...
  // ── القيم الافتراضية ──
  let title       = SITE_NAME;
  let description = 'منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة — مصممة لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.';
  let bodyContent = '';
  ...
  if (pathname === '/') {
    bodyContent = `
      ...
      <p>منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة — مصممة لخدمة وتدريب طلاب الشريعة والقانون، ودعم المحامين والباحثين في تطوير ملكتهم المعرفية والقضائية.</p>
  ...
  // ── /about ──
    ...
    description = 'منصة الناصر القانونية — مبادرة أ. معين الناصر لخدمة طلاب الشريعة والقانون والمحامين والباحثين في اليمن. منصة رقمية مستقلة تضم أكثر من 25,000 سؤال مؤتمت ومكتبة قانونية متكاملة.';
