...
export default async function handler(_req: Request): Promise<Response> {
  ...
  // ── المكتبة القانونية ──
  entries.push(url(`${BASE_URL}/library`,                                     'weekly',  '0.9'));
  entries.push(url(`${BASE_URL}/library/search`,                              'weekly',  '0.8'));
  entries.push(url(`${BASE_URL}/library/legislation`,                         'weekly',  '0.8'));
  entries.push(url(`${BASE_URL}/library/judicial`,                            'weekly',  '0.8'));
  entries.push(url(`${BASE_URL}/library/prosecution`,                         'weekly',  '0.8'));
  entries.push(url(`${BASE_URL}/library/regulations`,                         'monthly', '0.7'));
  entries.push(url(`${BASE_URL}/library/other-services`,                      'monthly', '0.6'));
  entries.push(url(`${BASE_URL}/library/other-services/supreme-court`,        'monthly', '0.6'));
  entries.push(url(`${BASE_URL}/library/other-services/supreme-court/index`,  'monthly', '0.6'));
